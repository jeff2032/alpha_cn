            ...
            detail_rows.append(
                {
                    ...
                    "price_position_pct": _number(row.get("price_position_pct"), default=float("nan")),
                    "volume_ratio": _number(row.get("volume_ratio"), default=float("nan")),
                    "ret_20_pct": _number(row.get("ret_20_pct"), default=float("nan")),
                    "ret_60_pct": _number(row.get("ret_60_pct"), default=float("nan")),
                    "mtf_score": _number(row.get("mtf_score"), default=float("nan")),
                    "co_rise_count": _number(row.get("co_rise_count"), default=float("nan")),
                    "theme_rank": _number(row.get("theme_rank"), default=float("nan")),
